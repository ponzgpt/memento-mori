...
Do not include personal medical details or secrets in reports.

## Expectations

- Profile data should stay local.
- Release artifacts should preserve Apache-2.0 notices.
- Native installers should request only the permissions needed for tray/menu-bar operation.
- No warranty or support entitlement is provided.
