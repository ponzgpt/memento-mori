...

{
  ...
  const macSource = readFileSync(join(root, "native/macos/MementoMoriMenuBar.swift"), "utf8");
  ...
  assert.match(macInstaller, /swiftc "\$\{ROOT_DIR\}\/native\/macos\/MementoMoriMenuBar\.swift"/);
